...
export const questions = [
    ...
    },
    {
        ...
        entry: { label: '- Nice to meet you, my name is:', name: 'name', id: uuid.v4() }
    },
    {
        //[4]
        id: uuid.v4(),
    ...
    },
    {
        ...
        feedback: [
            { name: '- Actually I really like it! You did a great job.', goto: 7, opinion: 'v.good', id: uuid.v4() },
            { name: '- It is pretty cool, I like it.', goto: 7, opinion: 'good', id: uuid.v4() },
            { name: '- The website is not bad. But I would change few things.', goto: 7, opinion: 'average', id: uuid.v4() },
    ...
    },
    {
        //[7]
        id: uuid.v4(),
        question: 'Is there anything you would suggest me to change here?',
        feedback: [
